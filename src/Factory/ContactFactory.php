...
final class ContactFactory extends ModelFactory
{
    ...
    protected function getDefaults(): array
    {
        return [
            ...
            'city' => self::faker()->text(90),
            'contactNo' => self::faker()->text(10),
            'country' => self::faker()->text(90),
            'createdAt' => self::faker()->dateTime(),
            'isDeleted' => self::faker()->boolean(),
            'pinCode' => self::faker()->text(6),
            'referenceId' => self::faker()->randomNumber(),
            'state' => self::faker()->text(90),
            'updatedAt' => self::faker()->dateTime(),
            'usertype' => self::faker()->text(),
        ];
    }
